...
class TONWalletManager {
    ...
    // 🎯 REMOVED: All localStorage and sessionStorage methods
    // No more getStoredMnemonic(), getStoredWallets(), setStoredWallet(), storeMnemonicSecurely()

    // 🎯 NEW: Check if user has wallet
    async hasWallet() {
        return this.currentWallet !== null;
    }

    // 🎯 NEW: Get wallet address safely
    getWalletAddress() {
        return this.currentWallet?.address || null;
    }

    // 🎯 NEW: Clear current wallet (on logout)
    clearWallet() {
        this.currentWallet = null;
